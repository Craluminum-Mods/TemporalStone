...
public class ItemTemporalStone : Item
{
    public override string GetHeldItemName(ItemStack itemStack)
    {
        return Lang.Get("temporalstone:TemporalStone", Lang.Get("blockmaterial-Stone"), Lang.Get("item-gear-temporal"));
    }
    ...
    public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
    {
        ...
        {
            this.RefillSlotIfEmpty(slot, byEntity, (ItemStack itemstack) => itemstack.Collectible is ItemTemporalStone);
        }
